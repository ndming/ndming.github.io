* 2026.02.06# Paper on *Material-aware Gaussian Splatting for High-fidelity Mesh Reconstruction* accepted to **Eurographics 2026**.
* 2025.11.17# Joined [VinMotion](https://vinmotion.net/) as an AI research engineer, working on neural scene 3D reconstruction from robot sensors for scalable sim-to-real transfer.
...
* 2025.08.15# Published GS-2M project page and code, check it out [here](https://ndming.github.io/publications/gs2m/).
...
* 2024.09.15# [Poster](https://www.researchgate.net/publication/389939390_Deep-Learning-Based_Spatially_Coherent_Lighting_for_Realistic_Virtual_Object_Insertion) on *Deep-Learning-Based Spatially Coherent Lighting for Realistic Virtual Object Insertion* accepted to **CVCS 2024**.
...
* 2022.10.31# Paper on *An IoT Solution for Multiple Sensors Control and Management* accepted to **NICS 2022**.
* 2022.08.23# Paper on *An FPGA-based Solution for Convolution Operation Acceleration* accepted to **ICIT 2022**.
